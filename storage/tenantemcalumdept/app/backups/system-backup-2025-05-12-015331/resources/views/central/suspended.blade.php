            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="text-center">
                        ...
                        <div class="mb-6">
                            <h3 class="text-lg font-medium text-gray-900">Domain 
                                Details</h3>
                            <p class="mt-1 text-sm text-gray-600">Your Domain 
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            ...
                            <p class="text-sm text-gray-700 mb-4">Your Domain 
                                has been suspended and you cannot access your tenant site at this time. If you believe this is an error, please contact support.</p>
