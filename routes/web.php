...
foreach (config('tenancy.central_domains') as $domain) {
    Route::domain($domain)->name('central.')->group(function () {
        ...
        })->middleware(['auth', 'verified', \App\Http\Middleware\EnsureCentralAdmin::class])->name('dashboard');
        ...
        // Central domain uses separate auth routes (admin only, no registration)
