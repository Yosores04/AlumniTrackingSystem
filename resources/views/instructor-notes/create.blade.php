...
@section('title', 'Add Instructor Note - ' . $alumni->name)
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-semibold text-gray-900">Add Instructor Note</h2>
                ...
                <form action="{{ route('alumni.instructor-notes.store', $alumni) }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select id="note_type" 
                                ...
                                <option value="academic" {{ old('note_type') == 'academic' ? 'selected' : '' }}>Academic</option>
                                <option value="behavioral" {{ old('note_type') == 'behavioral' ? 'selected' : '' }}>Behavioral</option>
                                <option value="performance" {{ old('note_type') == 'performance' ? 'selected' : '' }}>Performance</option>
                                <option value="general" {{ old('note_type') == 'general' ? 'selected' : '' }}>General</option>
                            </select>
                        </div>
