        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="flex border-b">
                    <button id="create-tab-btn" class="px-6 py-3 w-1/3 text-center border-b-2 border-blue-500 text-blue-500 font-medium">
                        Create New Tenant
                    </button>
                    <button id="list-tab-btn" class="px-6 py-3 w-1/3 text-center text-gray-500 hover:text-gray-700 font-medium">
                        Manage Tenants
                    </button>
                    <a href="{{ route('domain-requests.index') }}" class="px-6 py-3 w-1/3 text-center text-gray-500 hover:text-gray-700 font-medium">
                        Domain Requests
                    </a>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            createTabBtn.addEventListener('click', function() {
                ...
                createTabBtn.classList.add('border-blue-500', 'text-blue-500');
                createTabBtn.classList.remove('text-gray-500');
                listTabBtn.classList.remove('border-blue-500', 'text-blue-500');
                listTabBtn.classList.add('text-gray-500');
            ...
            listTabBtn.addEventListener('click', function() {
                ...
                listTabBtn.classList.add('border-blue-500', 'text-blue-500');
                listTabBtn.classList.remove('text-gray-500');
                createTabBtn.classList.remove('border-blue-500', 'text-blue-500');
                createTabBtn.classList.add('text-gray-500');
